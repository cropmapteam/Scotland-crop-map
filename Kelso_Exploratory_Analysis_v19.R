...
# v19 - split dataset into VV & VH subsets for MEAN and VARIANCE, 
#       add LCTYPE plots 
...
ggplot(data=subset(allData, LCGROUP == "Permanent Crops"), aes(x=LCTYPE)) + 
        geom_histogram(stat="count", fill="#F4EDCA") + 
        theme(legend.position="top", legend.direction = "horizontal") + 
        coord_flip() + 
...
ggplot(data=meanVVtime, aes(x=ind, y=values, colour=LCTYPE )) +
    geom_line() + 
...
ggplot(data=meanVHtime, aes(x=ind, y=values, colour=LCTYPE )) +
    geom_line() + 
    theme(legend.position="bottom", legend.direction = "horizontal") + 
    scale_x_discrete(name = "2018", 
                     limits = c("Jan", "Feb", "Mar","Apr","May",
...
# Create Time-Series and Plot VV variable #### 
...
# Replace the name given to column when stacked
varVVtime$VVmean <- varVVtime$values
str(varVVtime)
...
ggplot(data=varVVtime, aes(x=ind, y=values, colour=LCTYPE )) +
    geom_line() + 
    theme(legend.position="bottom", legend.direction = "horizontal") + 
    scale_x_discrete(name = "2018", 
                     limits = c("Jan", "Feb", "Mar","Apr","May",
                                "June","July","Aug","Sept")) + 
    labs(title="VV Variable by Month by Land Cover Type", 
         y = "VV mean") + 
    plot_subtitle + 
    plot_caption + 
    plot_theme 

# Create Time-Series and Plot VH variable #### 
# draft code by Zarah Pattison, Env. Researcher on ScotCropMap team 
...
# Replace the name given to column when stacked
varVHtime$VVmean <- varVHtime$values
str(varVHtime)
...
ggplot(data=varVHtime, aes(x=ind, y=values, colour=LCTYPE )) +
    geom_line() + 
    theme(legend.position="bottom", legend.direction = "horizontal") + 
    scale_x_discrete(name = "2018", 
                     limits = c("Jan", "Feb", "Mar","Apr","May",
                                "June","July","Aug","Sept")) + 
    labs(title="VH Variable by Month by Land Cover Type", 
         y = "VH mean") + 
    plot_subtitle + 
    plot_caption + 
    plot_theme 
