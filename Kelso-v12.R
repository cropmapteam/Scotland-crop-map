...
########################################################### 
# To comment a block of code: select your code then click Ctrl + shift + C 
...
########################################################### 
modelAll <- randomForest(LCTYPE ~ ., data = train, mtry=mTry, ntree=nTree, nodesize=nodeSize, importance=T)
modelAll 
...
########################################################### 
# RANDOM FOREST model - Top 25 variables 
########################################################### 
...
########################################################### 
# RANDOM FOREST model - Top 15 variables 
########################################################### 
