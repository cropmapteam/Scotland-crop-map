...
# Kelso_Random_Forest_allCrops_nTree300_60-40split-mTry13 - not TGRS crops grouped but not deleted  
...
# nTree=300 
#pdf(file="Kelso_Random_Forest_AllCrops_50-50_nTree300_mTry13.pdf")
#txtStart(file="Kelso_Random_Forest_AllCrops_50-50_nTree300_mTry13.txt", commands=TRUE, results=TRUE, append=FALSE) 

#pdf(file="Kelso_Random_Forest_AllCrops_60-40_nTree300_mTry13.pdf")
#txtStart(file="Kelso_Random_Forest_AllCrops_60-40_nTree300_mTry13.txt", commands=TRUE, results=TRUE, append=FALSE) 

#pdf(file="Kelso_Random_Forest_AllCrops_70-30_nTree300_mTry13.pdf")
#txtStart(file="Kelso_Random_Forest_AllCrops_70-30_nTree300_mTry13.txt", commands=TRUE, results=TRUE, append=FALSE) 

#pdf(file="Kelso_Random_Forest_AllCrops_80-20_nTree300_mTry13.pdf")
#txtStart(file="Kelso_Random_Forest_AllCrops_80-20_nTree300_mTry13.txt", commands=TRUE, results=TRUE, append=FALSE) 
...
write.csv(KelsoClassifiedCropsAll, file = "Kelso_classified_crops_result_from_AllVariables_Model_AllCrops.csv") 
...
write.csv(KelsoClassifiedCropsTop, file = "Kelso_classified_crops_result_from_TopVariables_Model_AllCrops.csv") 
...
write.csv(KelsoClassifiedCropsLess, file = "Kelso_classified_crops_result_from_LessVariables_Model_AllCrops.csv") 
