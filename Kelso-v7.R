...
# by LCTYPE by AREA size: Small, Med, Large 
smallArea = 10 
largeArea = 20 
...
# Soow model performance (Actual VS Predicted)
confMatrix <- table(test$LCTYPE, predicted, dnn = c("Actual", "Predicted"))
confMatrix 

# Plot Predicted Output
plot(predicted, col="deepskyblue1", 
     bty="o", 
     cex.main=1.2, cex.lab=1, cex.axis=1, 
     main="rfModel (allVars): Predicted Crop Types", 
     las=2, 
     xlab="Crop Type", ylab="Number of fields")

# Plot Predict Output VS Original 
# ..........to do ......... 
...
# Plot Predicted Output
plot(predicted, col="darkseagreen2", 
     bty="o", 
     cex.main=1.2, cex.lab=1, cex.axis=1, 
     main="rfModel (top25Vars): Predicted Crop Types", 
     las=2, 
     xlab="Crop Type", ylab="Number of fields")
